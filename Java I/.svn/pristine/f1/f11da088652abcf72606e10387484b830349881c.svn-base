...
public class TestLinkedListOfInts {
	...
	@Test
	public void basic() {
		List flist = genNewList();
		List rlist = genNewList();
	...
	public void nestedIterator2() {
		...
		List plist1 = genNewList();
		List plist2 = genNewList();
