...
/*	TA: AlecS
* Grade: 96/100
* 	No class header JavaDoc -1
*	JavaDocs only list parameters, they should also explain the purpose of the method. -3
*/
...
public class Lab5Methods {
	...
	public static boolean isPalindrome(String s) {
		boolean x = true;
		String[] letters = s.split("");				//can also use chatAt() or char string
	 ...
	 * @param dobule array exams
	 * @param boolean studios
	 * @param integer extensions
	 * @return letter grade
	 */
